...
class Designer extends CI_Controller
{
    ...
    {
        $this->form_validation->set_rules('email', 'Email Designer', 'required');
        $this->form_validation->set_rules('nama', 'Nama Designer', 'required');
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            if ($this->upload->do_upload('foto')) {
                ...
                $this->Designer_model->add('data_designer', $items);
